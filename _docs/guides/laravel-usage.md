...
In order to use JsonMapper with your [Laravel](https://laravel.com) application you only need 
JsonMapper's [LaravelPackage](https://github.com/JsonMapper/LaravelPackage). 
