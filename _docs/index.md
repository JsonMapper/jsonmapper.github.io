...
JsonMapper requires PHP 7.4 or higher. Anything added during the 2.x line carries an "Available since"
line naming the release that introduced it; everything else has been there since 2.0. The release these
pages describe is shown at the foot of the sidebar.
