...
object to best fit your needs. As an example the JsonMapperFactory will load both the [DocBlock Annotations](/_docs/middleware/doc-block-annotations.md) 
and the [Types Properties](/_docs/middleware/typed-properties.md) middleware which do the same for different version of the PHP runtime.
