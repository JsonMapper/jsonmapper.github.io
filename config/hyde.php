...
return [
    ...
    */
    ...
    'rss' => [
        ...
        'description' => env('SITE_NAME', 'JsonMapper').' RSS Feed',
    ],
    ...
    */
    ...
    'footer' => 'Documentation for [JsonMapper](https://github.com/JsonMapper/JsonMapper).',
    ...
    */
    ...
    'navigation' => [
        ...
        'custom' => [
            Navigation::item('https://github.com/JsonMapper/JsonMapper', 'GitHub', 200),
        ],
